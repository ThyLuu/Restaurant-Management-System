        ...
        try {
            ...
            if (validateRequestMap(requestMap)){
                ...
                String data = "Name: " + requestMap.get("name") + "\n" +
                        ...
                        "Payment method: " + requestMap.get("paymentMoethod");
                ...
                Paragraph chuck = new Paragraph("Restaurant Management System", getFont("Header"));
    ...
    public ResponseEntity<String> deleteBill(Integer id) {
        try {
            ...
            if (!optional.isEmpty()){
                ...
                return RestaurantUtils.getResponseEntity("Bill deleted successfully", HttpStatus.OK); //xóa bill thành công
            }
            return RestaurantUtils.getResponseEntity("Bill id doesn't exist", HttpStatus.OK); // bill id không tồn tại
        }
        catch (Exception ex){
            ex.printStackTrace();
        }
